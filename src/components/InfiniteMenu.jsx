  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-none w-full h-full overflow-hidden relative outline-none active:cursor-none"
      />
        ...
        `}
          ...
          ${
            isMoving
              ...
              : 'bottom-[5em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
          }
        `}
          >
            <p className="select-none relative text-[#060010] -top-[15px] text-[70px]">&#x2197;</p>
          </div>
        </>
      )}
    </div>
